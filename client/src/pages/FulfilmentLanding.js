...
const FulfilmentLanding = () => {
  ...
  return (
    <>
      <div className={styles.fulfilmentLanding}>
        ...
        <div className={styles.fulfilmentDisplay}>
          ...
          <div className={styles.fulfilmentHoneyOrder}>
            <div className={styles.fulfilmentHoneyOrderChild} />
          ...
          <div className={styles.fulfilmentHoneyOrder1}>
            <div className={styles.fulfilmentHoneyOrderChild} />
            <div className={styles.maskGroup}>
              <img
                className={styles.maskGroupChild}
                alt=""
                src="/rectangle-671@2x.png"
              />
            </div>
            <button
              className={styles.rectangleContainer}
          ...
          <div className={styles.fulfilmentHoneyOrder2}>
            <div className={styles.fulfilmentHoneyOrderChild} />
            <div className={styles.maskGroup}>
              <img
                className={styles.maskGroupChild}
                alt=""
                src="/rectangle-672@2x.png"
              />
            </div>
            <button
              className={styles.rectangleContainer}
          ...
          <div className={styles.fulfilmentHoneyOrder3}>
            <div className={styles.fulfilmentHoneyOrderChild} />
            <div className={styles.maskGroup}>
              <img
                className={styles.maskGroupChild}
                alt=""
                src="/rectangle-673@2x.png"
              />
            </div>
            <button
              className={styles.rectangleContainer}
          ...
          <div className={styles.fulfilmentHoneyOrder4}>
            <div className={styles.fulfilmentHoneyOrderChild} />
            <div className={styles.maskGroup}>
              <img
                className={styles.maskGroupChild}
                alt=""
                src="/rectangle-674@2x.png"
              />
            </div>
            <button
              className={styles.rectangleContainer}
          ...
          <div className={styles.fulfilmentHoneyOrder5}>
            <div className={styles.fulfilmentHoneyOrderChild} />
            <div className={styles.maskGroup}>
              <img
                className={styles.maskGroupChild}
                alt=""
                src="/rectangle-675@2x.png"
              />
            </div>
            <button
              className={styles.rectangleContainer}
          ...
          <div className={styles.fulfilmentHoneyOrder6}>
            <div className={styles.fulfilmentHoneyOrderChild} />
            <div className={styles.maskGroup}>
              <img
                className={styles.maskGroupChild}
                alt=""
                src="/rectangle-676@2x.png"
              />
            </div>
            <button
              className={styles.rectangleContainer}
          ...
          <div className={styles.fulfilmentHoneyOrder7}>
            <div className={styles.fulfilmentHoneyOrderChild} />
            <div className={styles.maskGroup}>
              <img
                className={styles.maskGroupChild}
                alt=""
                src="/rectangle-677@2x.png"
              />
            </div>
            <button
              className={styles.rectangleContainer}
          ...
          <div className={styles.fulfilmentHoneyOrder8}>
            <div className={styles.fulfilmentHoneyOrderChild} />
            <div className={styles.maskGroup}>
              <img
                className={styles.maskGroupChild}
                alt=""
                src="/rectangle-678@2x.png"
              />
            </div>
            <div className={styles.groupDiv} onClick={onGroupContainer6Click}>
              <div className={styles.groupChild4} />
              <div className={styles.bid8}>BID</div>
            </div>
            <div className={styles.requirementXxxLocationContainer8}>
              <p className={styles.requirementXxx}>
                Requirement: xxx location: xyz
              </p>
              <p className={styles.requirementXxx}>By Date: yyy</p>
            </div>
            <div className={styles.honey18}>Honey 1</div>
          </div>
          <div className={styles.fulfilmentHoneyOrder9}>
            <div className={styles.fulfilmentHoneyOrderChild} />
            <div className={styles.maskGroup}>
              <img
                className={styles.maskGroupChild}
                alt=""
                src="/rectangle-679@2x.png"
              />
            </div>
          ...
          <div className={styles.fulfilmentHoneyOrder10}>
            <div className={styles.fulfilmentHoneyOrderChild} />
            <div className={styles.maskGroup}>
              <img
                className={styles.maskGroupChild}
                alt=""
                src="/rectangle-6710@2x.png"
              />
            </div>
          ...
          <div className={styles.fulfilmentHoneyOrder11}>
            <div className={styles.fulfilmentHoneyOrderChild} />
            <div className={styles.maskGroup}>
              <img
                className={styles.maskGroupChild}
                alt=""
                src="/rectangle-6711@2x.png"
              />
            </div>
        ...
        <div className={styles.headerFulfilment}>
          ...
          <div className={styles.navbar}>
            ...
            <div className={styles.homeParent}>
              ...
              <div className={styles.home} onClick={onMarketPlaceTextClick}>
                Market Place
              </div>
              <b
                className={styles.marketPlace1}
...
export default FulfilmentLanding;
